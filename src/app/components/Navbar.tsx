...
export default function Navbar({
  ...
  return (
    <nav className="shadow px-4 py-3">
      ...
      <div>
        {subscriptionDays && <div className={`text-sm px-4 py-1 ${subscriptionDays <= 7 ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"} md:hidden  font-normal rounded-full max-w-fit text mx-auto`}>
        Il reste {subscriptionDays} jours avant l&apos;expiration de votre abonnement.
